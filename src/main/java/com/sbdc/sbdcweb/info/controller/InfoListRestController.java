...
public class InfoListRestController extends InfoRestController<InfoList, Long> {
    private final InfoListService infoListService;

    @Autowired
    public InfoListRestController(InfoListService infoListService, FileManager fileManager) {
		super(infoListService, fileManager);
