 ...
 */
@Service
public class InfoBusinessServiceImpl extends InfoServiceImpl<InfoBusiness, Long> implements InfoBusinessService {
	private static final Logger logger = LoggerFactory.getLogger(InfoBusinessServiceImpl.class);

	private final InfoBusinessRepository infoBusinessRepository;
    private final FileManager fileManager;
    private final String infoCode = "infobusiness";
	...
	@Autowired
    public InfoBusinessServiceImpl(InfoBusinessRepository infoBusinessRepository, FileManager fileManager) {
        super(infoBusinessRepository);
        super.setInfoCode(infoCode);
        super.setPathName(pathName);
        super.setBbsCode("");
        this.infoBusinessRepository = infoBusinessRepository;
     ...
     */
    @Override
    public List<InfoBusiness> selectInfoList() {
        List<InfoBusiness> infoList = super.selectInfoList();
	 ...
	 */
    @Override
    public InfoBusiness insertInfo(InfoBusiness infoRequest, MultipartFile upload) {
    	if (upload != null) {
            // 업로드 파일명
     ...
     */
    @Override
    public InfoBusiness updateInfo(Long id, InfoBusiness infoRequest, MultipartFile upload) {
    	InfoBusiness info = super.select(id);
    ...
    public Map<String, Object> delete(Long id) {
    	...
    	if (info != null) {
	        try {
	        	...
	        	infoBusinessRepository.delete(info);
	    		deleteYN = true;
	    	} catch (Exception e) {
