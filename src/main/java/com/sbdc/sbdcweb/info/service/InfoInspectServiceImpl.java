...
import com.sbdc.sbdcweb.info.repository.InfoInspectRepository;
 ...
 */
@Service
public class InfoInspectServiceImpl extends InfoServiceImpl<InfoInspect, Long> implements InfoInspectService {
	private static final Logger logger = LoggerFactory.getLogger(InfoInspectServiceImpl.class);

	private final InfoInspectRepository infoInspectRepository;
    private final FileManager fileManager;
    private final String infoCode = "infoinspect";
    ...
    @Autowired
    public InfoInspectServiceImpl(InfoInspectRepository infoInspectRepository, FileManager fileManager) {
        super(infoInspectRepository);
        super.setInfoCode(infoCode);
        super.setPathName(pathName);
        super.setBbsCode("");
        this.infoInspectRepository = infoInspectRepository;
     ...
     */
    @Override
    public List<InfoInspect> selectInfoList() {
        List<InfoInspect> infoList = super.selectInfoList();
	 ...
	 */
    @Override
    public InfoInspect insertInfo(InfoInspect infoRequest, MultipartFile upload) {
    	if (upload != null) {
            // 업로드 파일명
     ...
     */
    @Override
    public InfoInspect updateInfo(Long id, InfoInspect infoRequest, MultipartFile upload) {
    	InfoInspect info = super.select(id);
    ...
    public Map<String, Object> delete(Long id) {
    	...
    	if (info != null) {
	        try {
	        	...
	        	infoInspectRepository.delete(info);
	    		deleteYN = true;
	    	} catch (Exception e) {
