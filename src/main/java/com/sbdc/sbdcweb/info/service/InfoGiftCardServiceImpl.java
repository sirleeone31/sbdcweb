...
import com.sbdc.sbdcweb.info.repository.InfoGiftCardRepository;
 ...
 */
@Service
public class InfoGiftCardServiceImpl extends InfoServiceImpl<InfoGiftCard, Long> implements InfoGiftCardService {
	private static final Logger logger = LoggerFactory.getLogger(InfoGiftCardServiceImpl.class);

	private final InfoGiftCardRepository infoGiftCardRepository;
    private final FileManager fileManager;
    private final String infoCode = "infogiftcard";
    ...
    @Autowired
    public InfoGiftCardServiceImpl(InfoGiftCardRepository infoGiftCardRepository, FileManager fileManager) {
        super(infoGiftCardRepository);
        super.setInfoCode(infoCode);
        super.setPathName(pathName);
        super.setBbsCode("");
        this.infoGiftCardRepository = infoGiftCardRepository;
     ...
     */
    @Override
    public List<InfoGiftCard> selectInfoList() {
        List<InfoGiftCard> infoList = super.selectInfoList();
	 ...
	 */
    @Override
    public InfoGiftCard insertInfo(InfoGiftCard infoRequest, MultipartFile upload) {
    	if (upload != null) {
            // 업로드 파일명
     ...
     */
    @Override
    public InfoGiftCard updateInfo(Long id, InfoGiftCard infoRequest, MultipartFile upload) {
    	InfoGiftCard info = super.select(id);
    ...
    public Map<String, Object> delete(Long id) {
    	...
    	if (info != null) {
	        try {
	        	...
	        	infoGiftCardRepository.delete(info);
	    		deleteYN = true;
	    	} catch (Exception e) {
