...
import com.sbdc.sbdcweb.info.repository.InfoRecordsRepository;
 ...
 */
@Service
public class InfoRecordsServiceImpl extends InfoServiceImpl<InfoRecords, Long> implements InfoRecordsService {
	private static final Logger logger = LoggerFactory.getLogger(InfoRecordsServiceImpl.class);

	private final InfoRecordsRepository infoRecordsRepository;
    private final FileManager fileManager;
    private final String infoCode = "inforecords";
    ...
    @Autowired
    public InfoRecordsServiceImpl(InfoRecordsRepository infoRecordsRepository, FileManager fileManager) {
        super(infoRecordsRepository);
        super.setInfoCode(infoCode);
        super.setPathName(pathName);
        super.setBbsCode("");
        this.infoRecordsRepository = infoRecordsRepository;
     ...
     */
    @Override
    public List<InfoRecords> selectInfoList() {
        List<InfoRecords> infoList = super.selectInfoList();
	 ...
	 */
    @Override
    public InfoRecords insertInfo(InfoRecords infoRequest, MultipartFile upload) {
    	if (upload != null) {
            // 업로드 파일명
     ...
     */
    @Override
    public InfoRecords updateInfo(Long id, InfoRecords infoRequest, MultipartFile upload) {
    	InfoRecords info = super.select(id);
    ...
    public Map<String, Object> delete(Long id) {
    	...
    	if (info != null) {
	        try {
	        	...
	        	infoRecordsRepository.delete(info);
	    		deleteYN = true;
	    	} catch (Exception e) {
