...
import com.sbdc.sbdcweb.info.repository.InfoBusiRepository;
 ...
 */
@Service
public class InfoBusiServiceImpl extends InfoServiceImpl<InfoBusi, Long> implements InfoBusiService {
	private static final Logger logger = LoggerFactory.getLogger(InfoBusiServiceImpl.class);

	private final InfoBusiRepository infoBusiRepository;
    private final FileManager fileManager;
    private final String infoCode = "infobusi";
    ...
    @Autowired
    public InfoBusiServiceImpl(InfoBusiRepository infoBusiRepository, FileManager fileManager) {
        super(infoBusiRepository);
        super.setInfoCode(infoCode);
        super.setPathName(pathName);
        super.setBbsCode("");
        this.infoBusiRepository = infoBusiRepository;
     ...
     */
    @Override
    public List<InfoBusi> selectInfoList() {
        List<InfoBusi> infoList = super.selectInfoList();
	 ...
	 */
    @Override
    public InfoBusi insertInfo(InfoBusi infoRequest, MultipartFile upload) {
    	if (upload != null) {
            // 업로드 파일명
     ...
     */
    @Override
    public InfoBusi updateInfo(Long id, InfoBusi infoRequest, MultipartFile upload) {
    	InfoBusi info = super.select(id);
    ...
    public Map<String, Object> delete(Long id) {
    	...
    	if (info != null) {
	        try {
	        	...
	        	infoBusiRepository.delete(info);
	    		deleteYN = true;
	    	} catch (Exception e) {
