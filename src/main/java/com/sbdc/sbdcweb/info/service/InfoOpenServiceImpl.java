...
import com.sbdc.sbdcweb.info.repository.InfoOpenRepository;
 ...
 */
@Service
public class InfoOpenServiceImpl extends InfoServiceImpl<InfoOpen, Long> implements InfoOpenService {
	private static final Logger logger = LoggerFactory.getLogger(InfoOpenServiceImpl.class);

	private final InfoOpenRepository infoOpenRepository;
	private final FileManager fileManager;
    private final String infoCode = "infoopen";
	...
	@Autowired
	public InfoOpenServiceImpl(InfoOpenRepository infoOpenRepository, FileManager fileManager) {
        super(infoOpenRepository);
        super.setInfoCode(infoCode);
        super.setPathName(pathName);
        super.setBbsCode("");
        this.infoOpenRepository = infoOpenRepository;
     ...
     */
    @Override
    public List<InfoOpen> selectInfoList() {
        List<InfoOpen> infoList = super.selectInfoList();
	 ...
	 */
    @Override
    public InfoOpen insertInfo(InfoOpen infoRequest, MultipartFile upload) {
    	if (upload != null) {
            // 업로드 파일명
     ...
     */
    @Override
    public InfoOpen updateInfo(Long id, InfoOpen infoRequest, MultipartFile upload) {
    	InfoOpen info = super.select(id);
    ...
    public Map<String, Object> delete(Long id) {
    	...
    	if (info != null) {
	        try {
	        	...
	        	infoOpenRepository.delete(info);
	    		deleteYN = true;
	    	} catch (Exception e) {
