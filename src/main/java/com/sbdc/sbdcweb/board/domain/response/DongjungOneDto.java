...
/**
 * 중소기업뉴스 게시판 특정 게시물 조회 시 일부 컬럼 조회를 위한 DTO
 * 
 * @author  : 이승희
 * @version : 1.0
 * @since   : 1.0
...
public class DongjungOneDto {
    ...
    public DongjungOneDto(Long articleKey, Long articleNo, String subject, 
    ...
    // 수정 시 파일용 생성자
    public DongjungOneDto(Long articleKey, String bbsCode, Long articleNo, 
